...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, router, nativeStorage, navCtrl) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (status == "true") {
                // alert('status == true');
                _this.router.navigate(['/onboaring'], { replaceUrl: true });
            }
            else {
                // alert('else');
...
/* harmony import */ var ionic4_rating__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ionic4-rating */ "./node_modules/ionic4-rating/dist/index.js");
...
var CommonService = /** @class */ (function () {
    function CommonService(http, loadingController) {
        this.http = http;
